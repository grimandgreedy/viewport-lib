...
pub use self::scivis::stores::{PolylineId, RibbonId, StreamtubeId, TubeId};
...
pub(crate) use self::scivis::stores::{PolylineStore, RibbonStore, StreamtubeStore, TubeStore};
