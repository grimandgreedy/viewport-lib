//! GPU implicit surface types.
//!
//! Public API: [`GpuImplicitItem`](crate::renderer::GpuImplicitItem),
//! [`ImplicitPrimitive`], [`ImplicitBlendMode`], [`GpuImplicitOptions`].
...
/// March configuration for a [`GpuImplicitItem`](crate::renderer::GpuImplicitItem).
