...
pub use renderer::{
    ...
    OverlayAnchor, OverlayAnimations, OverlayClip, OverlayEasing, OverlayFill, OverlayFrame,
    OverlayGeometryId, OverlayPolylineItem, OverlayShape, OverlayShapeItem, OverlayStroke,
