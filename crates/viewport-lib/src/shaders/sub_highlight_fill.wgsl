...
// colour. Polygon-offset depth bias is configured on the pipeline so the fill
...
// Group 1: SubHighlightUniform (fill_colour, edge_colour, edge_width, vertex_size,
