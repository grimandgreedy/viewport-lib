//! Minimal viewport-lib example using eframe / egui 0.36 on the wgpu 30 leg.
//!
//! Same as `eframe_minimal`, but pinned to egui 0.36 (which pairs with wgpu 30)
//! to exercise viewport-lib's `wgpu30` feature against a wgpu 30 host. Build it
//! with `--no-default-features --features wgpu30`.
//!
//! Navigation:
