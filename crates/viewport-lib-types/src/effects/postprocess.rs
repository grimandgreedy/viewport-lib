...
impl ExposureSettings {
    ...
    #[doc(hidden)]
    pub fn base_ev100(&self) -> Option<f32> {
        match self.mode {
    ...
    #[doc(hidden)]
    pub fn manual_multiplier(&self) -> Option<f32> {
        self.base_ev100()
...
///
/// Passed via `EffectsFrame::display`. Groups the three
...
/// `EffectsFrame::display`); on [`PipelineMode::Direct`]
