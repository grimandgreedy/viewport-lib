...
pub(crate) fn build(app: &mut crate::App, renderer: &mut vpl::ViewportRenderer) {
    app.build_probe_widgets_scene(renderer);
...
pub(crate) struct ScProbeWidgets;

/// The registry's handle to this showcase.
pub(crate) static SHOWCASE: ScProbeWidgets = ScProbeWidgets;

impl crate::Showcase for ScProbeWidgets {
