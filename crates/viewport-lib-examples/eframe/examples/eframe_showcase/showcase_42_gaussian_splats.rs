...
pub(crate) fn build(app: &mut crate::App, renderer: &mut vpl::ViewportRenderer) {
    build_gaussian_splat_scene(app, renderer);
...
pub(crate) struct ScGaussianSplats;

/// The registry's handle to this showcase.
pub(crate) static SHOWCASE: ScGaussianSplats = ScGaussianSplats;

impl crate::Showcase for ScGaussianSplats {
