...
pub(crate) fn build(app: &mut crate::App, renderer: &mut vpl::ViewportRenderer) {
    build_sprite_scene(app, renderer);
...
pub(crate) struct ScSprites;

/// The registry's handle to this showcase.
pub(crate) static SHOWCASE: ScSprites = ScSprites;

impl crate::Showcase for ScSprites {
