...
pub(crate) struct ScPhysicallyBasedSurfaces;

/// The registry's handle to this showcase.
pub(crate) static SHOWCASE: ScPhysicallyBasedSurfaces = ScPhysicallyBasedSurfaces;

impl crate::Showcase for ScPhysicallyBasedSurfaces {
    ...
    fn controls(&self, app: &mut crate::App, ui: &mut crate::eframe::egui::Ui, _frame: &crate::eframe::Frame) {
        controls_physically_based_surfaces(app, ui)
    }
}
