    ...
    pub(crate) fn dc_lighting() -> LightingSettings {
        {
            ...
            _t.sky_colour = [0.08, 0.10, 0.18].into();
            _t.ground_colour = [0.15, 0.15, 0.20].into();
            _t
        }
    }
}
...
pub(crate) struct ScDepthCompositeImages;

/// The registry's handle to this showcase.
pub(crate) static SHOWCASE: ScDepthCompositeImages = ScDepthCompositeImages;

impl crate::Showcase for ScDepthCompositeImages {
