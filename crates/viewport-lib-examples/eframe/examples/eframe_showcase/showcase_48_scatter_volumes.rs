...
pub(crate) struct ScScatterVolumes;

/// The registry's handle to this showcase.
pub(crate) static SHOWCASE: ScScatterVolumes = ScScatterVolumes;

impl crate::Showcase for ScScatterVolumes {
