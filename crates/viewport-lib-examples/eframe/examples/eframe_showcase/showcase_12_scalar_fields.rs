...
pub(crate) struct ScScalarFields;

/// The registry's handle to this showcase.
pub(crate) static SHOWCASE: ScScalarFields = ScScalarFields;

impl crate::Showcase for ScScalarFields {
