...
pub(crate) fn scene(
    ...
    let (items, bg_colour, lighting, scene_gen, sel_gen) = {
        let items = app.lic_state.scene.collect_render_items(&vpl::Selection::new());
        let lighting = {
...
pub(crate) struct ScSurfaceLic;

/// The registry's handle to this showcase.
pub(crate) static SHOWCASE: ScSurfaceLic = ScSurfaceLic;

impl crate::Showcase for ScSurfaceLic {
