...
pub(crate) struct ScSurfaceVectors;

/// The registry's handle to this showcase.
pub(crate) static SHOWCASE: ScSurfaceVectors = ScSurfaceVectors;

impl crate::Showcase for ScSurfaceVectors {
