// Copied verbatim from crates/viewport-lib/src/shaders/bloom_threshold.wgsl at commit c2bb8f17.
// Any divergence from the built-in shader breaks the parity tests in tests/parity.rs.
