...
const CUBE_COLOURS: [[f32; 3]; 3] = [[0.95, 0.35, 0.30], [0.35, 0.80, 0.45], [0.35, 0.55, 1.0]];
...
impl App {
    pub(crate) fn build_foreground_scene(&mut self, renderer: &mut ViewportRenderer) {
        ...
        let props: [(f32, f32, f32, bool, [f32; 3]); 9] = [
            (-6.0, -5.0, 1.2, false, [0.85, 0.30, 0.25]),
            (-2.5, 4.5, 0.8, true, [0.30, 0.70, 0.85]),
            (5.5, -3.0, 1.5, false, [0.90, 0.72, 0.25]),
            (2.0, 7.5, 1.0, true, [0.55, 0.35, 0.85]),
            (-7.0, 6.0, 1.1, false, [0.25, 0.75, 0.45]),
            (7.0, 5.0, 0.7, true, [0.90, 0.45, 0.65]),
            (0.5, -6.5, 1.3, false, [0.40, 0.55, 0.90]),
            (-4.0, 0.5, 0.9, true, [0.95, 0.60, 0.30]),
            (4.0, 1.0, 1.4, false, [0.60, 0.80, 0.35]),
        ];
